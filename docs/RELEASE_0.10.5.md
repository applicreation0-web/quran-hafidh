...
- audited three-Tafsir cleanup and justified rendering;
...
Publication is authorized only through `.github/workflows/publish-0.10.5.yml` after every audit, unit test, APK boundary check and signature verification succeeds.
