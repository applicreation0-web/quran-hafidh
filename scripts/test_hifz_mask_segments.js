...
const {randomOrderKeys,randomSegmentsForCells}=require('../hifz-app/src/main/assets/hifzreader/reader.js');
const cells=[
...
// No rectangle can bridge whitespace: every segment remains inside its source-ink cell.
