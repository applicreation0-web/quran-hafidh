#!/usr/bin/env python3
"""Rewrite the generated 0.10.8 reader verifier with syntax-safe literals."""
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
path = ROOT / "scripts" / "verify_0108_reader_contract.py"
...
''', encoding="utf-8")
print("Rewrote syntax-safe 0.10.8 reader verifier")
