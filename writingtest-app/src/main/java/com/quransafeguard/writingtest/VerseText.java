 ...
 * for provenance — the same source used for waqf.json). Used only to build the hint (first
 * letters of the verse, WITH tashkil) — never rendered as the Mushaf page itself.
 */
